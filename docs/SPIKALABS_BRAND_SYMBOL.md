...
- Raster source reference: `assets/brand/spikalabs-symbol.png`
...
The mark should be described and reproduced with these features:

- **Purple angular core**: a vertical lightning/spark form that also reads as a lab-energy mark.
- **Black counter-shape**: a right-facing angular form that balances the purple core.
- **Pixel squares**: small black and purple square satellites that imply digital signals, experiments, and modular systems.
- **Sharp geometry**: straight edges and diagonal cuts; no rounded mascot or soft emblem treatment.
...
| Role | Value | Usage |
| --- | --- | --- |
| Symbol purple high | `#6A00FF` | Upper/top highlight in symbol gradients or icon previews. |
| Symbol purple core | `#6200EA` | Canonical primary purple and solid-color fallback. |
| Symbol purple deep | `#5200D8` | Lower/deeper purple stop when a gradient is useful. |
...
- Use the symbol as the default logo mark in kit banners, brand-board covers, app icons, favicons, headers, and hero visuals.
- Pair the mark with a lowercase mono wordmark when text is needed: `spikalabs`, `design-kit`, or `spikalabs-design-kit`.
- Place the full-color symbol on paper, white, or very light neutral backgrounds.
...
- Do not place the full-color symbol on busy photos, gradient mesh backgrounds, or saturated accent cards.
- Do not add soft glow, glass blur, or blurred drop shadows to the mark.

## Neo-brutal application pattern

Use the symbol as the crisp brand anchor, then apply Neo-brutalism to the surrounding system:

1. Put the symbol in a paper tile.
2. Add a 2px or 5px ink border to the tile.
3. Add a hard offset shadow or a second accent tile behind it.
4. Use bracketed mono labels around the tile, such as `[ brand ]`, `[ system ]`, or `[ lab mark ]`.
5. Keep the symbol itself clean, flat, and recognizable.
